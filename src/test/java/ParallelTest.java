...
public class ParallelTest {
    ...
    public void Addtocart() throws InterruptedException {
    	...
    	driver.findElement(By.id("gh-ac")).sendKeys("Adidas Neo");
    	driver.findElement(By.id("gh-btn")).click();
    	wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id=\"srp-river-results-listing1\"]/div/div[2]/a/h3")));
    	...
    	wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id=\"atcRedesignId_overlay-atc-container\"]/div/div[1]/div/div[2]/a[2]/span/span")));
    	...
    	String cartNum = driver.findElement(By.id("gh-cart-n")).getText();
    	Assert.assertEquals(cartNum, "2");
    	System.out.println("First product added in the cart: "+product1);
    	System.out.println("Second product added in the cart: "+product);
    	System.out.println("Items  added in the cart ="+cartNum);
    }
